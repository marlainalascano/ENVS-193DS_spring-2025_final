...
This figure shows model predictions of the probability of Swift Parrot occupancy in nest boxes as a function of distance to the forest edge in two different breeding seasons (2016 and 2019), with 95% confidence intervals. Predicted values are based on a logistic regression model including both season and edge distance as predictors.\
...
edge_points <- expand.grid(
  edge_distance = c(0, 900),
  season = c(2016, 2019) #Repeat each edge distance for both seasons
)
